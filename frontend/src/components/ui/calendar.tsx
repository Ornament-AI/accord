		...
		<DayPicker
			...
			classNames={{
				...
				button_previous: cn(
					...
					"size-(--cell-size) aria-disabled:opacity-50 p-0 select-none outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-inset",
			...
			components={{
				...
				Chevron: ({ className, orientation, ...props }) => {
					if (orientation === "left") {
						return <ChevronLeft size={16} className={className} {...props} />;
					}

					if (orientation === "right") {
						return <ChevronRight size={16} className={className} {...props} />;
					}

					return <ChevronDown size={16} className={className} {...props} />;
				},
