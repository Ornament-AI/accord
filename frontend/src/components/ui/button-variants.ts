...
export const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,background-color,border-color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/35 focus-visible:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
	{
		variants: {
			variant: {
				default:
					"bg-primary text-primary-foreground shadow-sm hover:bg-primary/92 hover:shadow-md dark:shadow-md dark:hover:shadow-lg",
				destructive:
					"bg-destructive text-white shadow-sm hover:bg-destructive/92 hover:shadow-md focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/72 dark:shadow-md dark:hover:shadow-lg",
				outline:
...
/** Subtle, near-transparent outline styling for data-page toolbar controls. */
export const toolbarOutlineClassName =
	"border-border bg-transparent shadow-2xs hover:bg-accent/62 hover:text-foreground hover:shadow-2xs dark:border-border dark:bg-input/22 dark:shadow-xs dark:hover:bg-input/38 dark:hover:border-border dark:hover:shadow-xs";
